...
strings are populated varies (the exact pattern experiments/narrative_context_ablation.py used
...
Run from repo root:
    .venv/bin/python experiments/run_four_arm_ablation.py                # tag + score
    .venv/bin/python experiments/run_four_arm_ablation.py --score-only   # reuse cached output
"""
import argparse
import json
import sys
...
CACHE_PATH = ROOT / "experiments" / "four_arm_ablation_output.json"
