...
Used across multiple tuning rounds (experiments/findings_retrieval.md R4) — pass
...
Run from repo root:
    .venv/bin/python experiments/run_production_pilot.py --round 0
"""
import argparse
import json
import sys
...
def main():
    ...
    out_path = ROOT / "experiments" / f"production_pilot_round{args.round}.json"
