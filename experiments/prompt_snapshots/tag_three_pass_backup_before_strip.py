...
LOCAL-FIELD DECISION RULES
These fields are local to the passage. Do not use later-scene or global
information to retroactively determine these labels — you only have the
TARGET passage plus its immediate previous/next neighbor here, and that is
by design.
...
- speaking_voice asks a completely different question: within the TARGET
  passage, whose voice/stance is actually being expressed? Determine who is
  actually responsible for the words in the passage. Distinguish carefully
  between: (1) the narrator's own voice, (2) a character's directly spoken
  words, (3) quoted speech embedded inside narration, (4) reported speech or
  paraphrase, (5) multiple voices when the passage genuinely contains more
  than one speaking participant. Do not infer a separate speaking voice
  merely because another character is mentioned, addressed, described, or
  quoted indirectly.
...
GOLD CONTRASTIVE ANCHORS — speaking_voice
Use these as behavioral anchors, not chunk-specific rules. Each one exists to
demonstrate a specific pattern, not to be memorized as an isolated fact.

--- ANCHOR 1: speaking_voice = "the Dreamer" (alone, plain reflection) ---
"Gardens or sauntered on the embankment, there was not one face of those I had been accustomed to meet at the same time and place all the year. They, of course, do not know me, but I know them. I know them intimately, I have almost made a study of their faces, and am delighted when they are gay, and downcast when they are under a cloud. I have almost struck up a friendship with one old man whom I meet every blessed day, at the same hour in Fontanka. ... I know the houses too. As I walk along they seem to run forward in the streets to look out at me from every window, and almost to say: "Good-morning! How do you do? I am quite well, thank God..."
WHY: The quoted lines ("Good-morning! How do you do?...") are the Dreamer's OWN
imagined personification of the houses, not another character's actual speech.
No one else is present or speaking. speaking_voice = "the Dreamer".

--- ANCHOR 2: speaking_voice = "the Dreamer" (third-person self-narration device) ---
"scarcely noticing that more than one passer-by smiles and turns round to look after him, and that a little girl, moving out of his way in alarm, laughs aloud, gazing open-eyed at his broad meditative smile and gesticulations. But fancy catches up in its playful flight the old woman, the curious passers-by, and the laughing child, and the peasants spending their nights in their barges on Fontanka (our hero, let us suppose, is walking along the canal-side at that moment)..."
WHY: The Dreamer is narrating himself as "our hero" / "he" as a deliberate
storytelling device (he explicitly asked Nastenka's permission to tell his own
story in the third person a few chunks earlier). Grammatical third person does
NOT mean a different speaker — it is still entirely his own voice.
speaking_voice = "the Dreamer".

--- ANCHOR 3: speaking_voice = "Nastenka" (alone, continuous monologue) ---
"\"Well, so you have survived!\" she said, pressing both my hands. \"I've been here for the last two hours; you don't know what a state I have been in all day.\" \"I know, I know. But to business. Do you know why I have come? Not to talk nonsense, as I did yesterday. I tell you what, we must behave more sensibly in future. I thought a great deal about it last night.\" \"In what way—in what must we be more sensible? I am ready for my part; but, really, nothing more sensible has happened to me in my life than this, now.\" \"Really? In the first place, I beg you not to squeeze my hands so; secondly, I must tell you that I spent a long time thinking about you and feeling doubtful to-day.\" \"And how did it end?\" \"How did it end? The upshot of it is that we must begin all over again..."
WHY: This reads like alternating dialogue at first glance, but it is actually
ONE person's continuous explanatory speech that poses and then answers its own
rhetorical questions ("And how did it end?" / "How did it end? The upshot of
it is...") — a stylistic device, not a second speaker's turn. Do not mistake a
monologue's self-directed rhetorical questions for dialogue alternation.
speaking_voice = "Nastenka" alone.

--- ANCHOR 4: speaking_voice = "the Dreamer and Nastenka" (Dreamer-dominant length) ---
"...saying that I have no chance of making the acquaintance of any woman; impressing upon her that it is a positive duty for a woman not to repulse so timid a prayer from such a luckless man as me. That, in fact, all I ask is, that she should say two or three sisterly words with sympathy... But you are laughing; however, that is why I am telling you....\" \"Don't be vexed; I am only laughing at your being your own enemy, and if you had tried you would have succeeded, perhaps, even though it had been in the street... I was judging by myself; I know a good deal about other people's lives.\" \"Oh, thank you,\" I cried; \"you don't know what you have done for me now!\""
WHY: The Dreamer's fantasy-speech is much longer, but Nastenka has a real,
substantive reply ("I was judging by myself; I know a good deal about other
people's lives") — a judgment, not filler. Length imbalance does not collapse
this to one voice. speaking_voice = "the Dreamer and Nastenka".

--- ANCHOR 5: speaking_voice = "the Dreamer and Nastenka" (Nastenka-dominant length) ---
"...Only a compact beforehand....\" \"A compact! Speak, tell me, tell me all beforehand; I agree to anything, I am ready for anything,\" I cried delighted. \"I answer for myself, I will be obedient, respectful ... you know me....\" \"It's just because I do know you that I ask you to come to-morrow,\" said the girl, laughing. \"I know you perfectly. But mind you will come on the condition... you won't fall in love with me.... I am ready for friendship; here's my hand.... But you mustn't fall in love with me, I beg you!\" \"I swear,\" I cried, gripping her hand...."
WHY: The reverse imbalance — Nastenka's "compact" speech is much longer, but
the Dreamer has two real lines ("I agree to anything, I am ready for
anything...I answer for myself" and "I swear," gripping her hand), both
tagged "I cried" not "I said". Tag style is not a signal of who "really"
spoke. speaking_voice = "the Dreamer and Nastenka".

--- ANCHOR 6: speaking_voice = "the Dreamer and Nastenka" (rapid alternation, no tags) ---
"\"Excellent! If you have been married to a Chinese Emperor, you will quite understand me. Come, listen.... But one minute, I don't know your name yet.\" \"At last! You have been in no hurry to think of it!\" \"Oh, my goodness! It never entered my head, I felt quite happy as it was....\" \"My name is Nastenka.\" \"Nastenka! And nothing else?\" \"Nothing else! Why, is not that enough for you, you insatiable person?\""
WHY: Six short lines in a row, only the passage BEFORE this excerpt has an
explicit tag ("added the girl"). Every line here is untagged but keeps
alternating Dreamer/Nastenka/Dreamer/Nastenka. Both have multiple real lines.
speaking_voice = "the Dreamer and Nastenka".

SPEAKER RELATION
speaker_relation describes the stance expressed by the speaker toward the
proposition/idea being expressed. Do not infer the relation merely from
emotional tone.

Distinguish:
- asserts: the speaker presents the proposition as something they affirm or
  state as true.
- explores: the speaker considers, imagines, speculates about, or plays with
  a possibility without firmly committing to it.
- doubts: the speaker explicitly questions, distrusts, or expresses
  uncertainty about the proposition.
- rejects: the speaker argues against or recoils from the proposition.

The key distinction is the speaker's epistemic/attitudinal stance, not
whether the surrounding passage is dramatic, emotional, humorous, or
fantastical.

CONTRASTIVE RULES

ASSERTS vs EXPLORES
Use asserts when the speaker is presenting something as their stated
position or experience. Use explores when the speaker is entertaining a
possibility, imagining a scenario, speculating, or deliberately leaving the
proposition open. Do not classify something as explores merely because the
content is fantastical.

EXPLORES vs DOUBTS
Use explores when the speaker is entertaining a possibility. Use doubts when
the speaker is actively questioning or expressing uncertainty about that
possibility. A hedge or hypothetical construction is not automatically
doubts.

DOUBTS vs ASSERTS
Use doubts only when uncertainty/questioning is actually expressed. A
speaker can describe an emotionally uncertain situation while still
asserting what they believe or experienced.

EMOTIONAL TONE IS NOT SPEAKER RELATION
Sadness, excitement, irony, enthusiasm, embarrassment, or tenderness do not
by themselves determine speaker_relation. Determine what the speaker is
doing with the proposition.
