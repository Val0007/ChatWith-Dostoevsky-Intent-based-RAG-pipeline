"""Runs BOTH LLM-judge ablations (src/production_llm_judge.py, src/scene_card_llm_judge.py)
...
Run from repo root:
    .venv/bin/python experiments/run_judge_ablation_pilot.py
"""
import json
import sys
...
def main():
    ...
    out_path = ROOT / "experiments" / "judge_ablation_results.json"
