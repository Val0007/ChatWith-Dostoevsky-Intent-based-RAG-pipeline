...
Differences from experiments/tagging/critic_fixer_loop.py (F10):
...
Usage:
    .venv/bin/python experiments/tagging/critic_fixer_loop_v2.py score <pass>
    .venv/bin/python experiments/tagging/critic_fixer_loop_v2.py critic <pass> <round_num>
    .venv/bin/python experiments/tagging/critic_fixer_loop_v2.py fixer <pass> <pattern_file> <round_num>
    .venv/bin/python experiments/tagging/critic_fixer_loop_v2.py log-round <pass> <round_num> <patch_summary> <kept|reverted>
"""
import json
import sys
...
LOG_DIR = ROOT / "experiments" / "tagging" / "results" / "critic_fixer_logs"
...
def _all_predictions_text(pass_name):
    gold = load_gold()
    cache_path = ROOT / "experiments" / "tagging" / "results" / "pass_cache" / f"{pass_name}.json"
