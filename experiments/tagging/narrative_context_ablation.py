...
Run from repo root:  .venv/bin/python experiments/tagging/narrative_context_ablation.py
Spends API (chunks x 4 arms x N calls). Logs go to experiments/tagging/FINDINGS.md by hand after.
"""
import json
import sys
