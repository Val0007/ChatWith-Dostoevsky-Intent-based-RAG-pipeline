...
Run from repo root:
    .venv/bin/python experiments/tagging/run_five_arm_comparison.py                # tag E + score all 5
    .venv/bin/python experiments/tagging/run_five_arm_comparison.py --score-only   # reuse cached E too
"""
import argparse
import json
import sys
...
FOUR_ARM_CACHE = ROOT / "experiments" / "tagging" / "results" / "four_arm_ablation_output.json"
FIVE_ARM_CACHE = ROOT / "experiments" / "tagging" / "results" / "five_arm_comparison_output.json"
