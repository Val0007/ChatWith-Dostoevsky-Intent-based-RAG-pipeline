"""Free (no-API) analyses of the current tags over data/tags.jsonl + data/context/.
...
Run from repo root:  .venv/bin/python experiments/tagging/analyze_tagger.py
"""
import json
...
tags = [json.loads(l) for l in open(ROOT / "data" / "tags.jsonl")]
