"""Runs src/production_with_dot_product.py (production_method's candidate pool, but
reranked by pure embedding dot-product instead of cheap_rerank's formula) over the
10-question gold set.

Run from repo root:
    .venv/bin/python experiments/run_dotproduct_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "dotproduct_pilot_results.json"
