"""Runs experiments/retrieval/variants/production_union_with_llm.py v3 (per-variant candidate ID union, final
...
Run from repo root:
    .venv/bin/python experiments/retrieval/run_production_union_llm_v3_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "production_union_llm_v3_pilot_results.json"
PROD_RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "production_pilot_final.json"
V2_RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "production_union_llm_pilot_results.json"
