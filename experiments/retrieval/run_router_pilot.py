...
Run from repo root:
    .venv/bin/python experiments/retrieval/run_router_pilot.py

Compares against the fixed-preset numbers already cached in
experiments/retrieval/results/retrieval_pilot_results.json (from run_retrieval_pilot.py) rather than
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "router_pilot_results.json"
