...
pilot (experiments/retrieval/gold/retrieval_gold_pilot10.json) and score whether each config's top-k
...
Run from repo root:
    .venv/bin/python experiments/retrieval/run_retrieval_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "retrieval_pilot_results.json"
