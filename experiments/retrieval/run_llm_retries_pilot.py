"""Runs experiments/retrieval/variants/production_llm_retries.py (pure production retrieval -> LLM sufficiency
check -> conditional second retrieval round) over the 10-question gold set.

Run from repo root:
    .venv/bin/python experiments/retrieval/run_llm_retries_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "llm_retries_pilot_results.json"
