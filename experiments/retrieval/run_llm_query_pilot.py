"""Runs experiments/retrieval/variants/llm_query_production.py (LLM query rewrite -> production_method's fuse with
externally-supplied intent -> cheap rerank -> diversify) over the 10-question gold set.

Run from repo root:
    .venv/bin/python experiments/retrieval/run_llm_query_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "llm_query_pilot_results.json"
