"""Runs experiments/retrieval/variants/scene_card_production.py's scene-cards-first pipeline over the 10-question
...
experiments/retrieval/FINDINGS.md R1-A / R4 (q01, q02, q10).

Run from repo root:
    .venv/bin/python experiments/retrieval/run_scene_card_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "scene_card_pilot_results.json"
