"""Runs experiments/retrieval/variants/production_with_hyde.py (HyDE hypothetical passage -> dense retrieval ->
union with original query's own fuse() top-N -> cheap_rerank anchored on original query)
over the 10-question gold set.

Run from repo root:
    .venv/bin/python experiments/retrieval/run_hyde_pilot.py
"""
import json
import sys
...
RESULTS_PATH = ROOT / "experiments" / "retrieval" / "results" / "hyde_pilot_results.json"
